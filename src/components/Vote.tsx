    ...
    return(
        <HomeStyle>
            ...
            <HomeContent>
                ...
                <CardsListStyle>
                    <Card typeCard="voting" title="Ajude a EthSP"  initialDate={'09/09/2022'} finalDate={'17/09/2022'} price={1000} description="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the"/>
